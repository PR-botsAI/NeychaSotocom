...
get_ipython().run_line_magic('pip', 'install asyncio ffmpeg ffprobe mcp openai openai-agents pydub scipy sounddevice uv --quiet')
get_ipython().run_line_magic('pip', 'install "openai-agents[voice]" --quiet')
