      ...
      <section className="container max-w-6xl relative" aria-labelledby="transformations-heading">
        ...
        <div className="relative">
          ...
          >
                  ...
                  <Card className="transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        ...
                        >
                          {/* Overlay de navegación en móviles con animación */}
                          ...
                          {imageError[`${case_.id}-${selectedImage}`] ? (
                            ...
                            <>
                              ...
                              {/* Overlay al hacer hover con animación mejorada */}
                          ...
                          {/* Guía de navegación inicial mejorada */}
            ...
            {/* Indicadores de posición con animación mejorada */}
            ...
            {/* Botones de navegación en desktop con animación mejorada */}
          ...
          {/* Contador de casos y CTA con animaciones */}
