...
const FAQS = [
  ...
  { q: "¿Qué hace especial este tratamiento?", a: "Combinamos fortalecimiento desde adentro con reconstrucción profesional — una apariencia natural hoy, y un ambiente limpio que favorece que tu uña natural crezca debajo. Evaluación personalizada y seguimiento continuo incluido." },
  { q: "¿Mi uña natural volverá a crecer sana?", a: "Te lo decimos con honestidad: depende de tu caso. La reconstrucción crea un ambiente limpio que favorece el crecimiento de la uña natural debajo, y muchos casos mejoran con el tiempo. En otros — por trauma u otras causas — la uña no volverá a crecer igual, y está bien: la reconstrucción mantiene una apariencia natural el tiempo que la necesites. Somos un servicio estético, no médico; en tu evaluación te decimos qué esperar en tu caso." },
  { q: "¿Cómo sé si mi caso necesita onicoplastia?", a: "Si tienes una uña con cambio de color, grosor, textura o forma por hongos, trauma u otra causa, es probable que la onicoplastia pueda ayudarte. La forma de confirmarlo con certeza es en persona: agenda tu primera sesión ($120) para un diagnóstico definitivo. Ese primer encuentro es justamente para eso — evaluar tu caso a fondo y definir tu plan." },
  { q: "¿Puedo saber el costo total antes de ir?", a: "La primera sesión es $120 (incluye evaluación completa, tratamiento fortalecedor, reconstrucción y GEL Polish). Los seguimientos son $80 cada 30 a 45 días. El número de sesiones varía según tu caso — esto se determina en la primera visita. No hay costos ocultos." },
];
