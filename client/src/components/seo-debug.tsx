...
function getPageKeywords(location: string): string {
  const baseKeywords = 'Neycha Soto, neychasoto.com, onicoplastia Hatillo Puerto Rico, reconstrucción estética uñas PR, uñas dañadas solución, especialista certificada en uñas, onicoplastia hombres y mujeres';
